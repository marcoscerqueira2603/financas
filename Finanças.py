...
with tab3:
    ...
    grafico_debito.add_trace(go.Bar(x=debito_mes_consolidado['Mês Referência'], y=debito_mes_consolidado['Valor_Orcamento'], name='Orçado' ), maker_color='#708090')
    grafico_debito.add_trace(go.Bar(x=debito_mes_consolidado['Mês Referência'], y=debito_mes_consolidado['Valor'], name='Real',maker_color='#00FF7F'))
