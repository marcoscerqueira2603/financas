...
if authentication_status:
  st.success(f'Bem-vindo de volta, {st.session_state["name"]}!')  
    ...
    st.error('Usuário ou senha incorretos. Redirecionando para o login...')
    authenticator.logout('Login', 'main')  # Isso pode redirecionar para o login, se necessário
elif authentication_status is None:
    st.warning('Você precisa se autenticar. Redirecionando para o login...')
    authenticator.login('Login', 'main')  # Força o login se não estiver autenticado
